...
import { Card, CardContent, CardMedia, Typography, Grid, Avatar, Box, CardActions } from "@mui/material";
...
export default function ShopProduct() {
    ...
    return (
        <Box sx={{ flexGrow: 1, m: 2 }}>
            ...
            <Grid container spacing={4} justifyContent="center" sx={{ maxWidth: "1400px", margin: "auto" }}>
                {products.map((product) => {
                    const imageUrl = `/api/product/image/${product._id}?${new Date().getTime()}`;
                    return (
                        <Grid
                            item
                            key={product._id}
