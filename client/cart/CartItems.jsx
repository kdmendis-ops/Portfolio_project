...
import { Card, CardContent, CardMedia, Button, TextField, Typography, Divider, Box } from "@mui/material";
            ...
            {cartItems.length > 0 ? (
                <>
                    ...
                    <Box sx={{ display: "flex", justifyContent: "flex-end", alignItems: "center", gap: 2, mt: 3 }}>
                        <Typography sx={{ fontSize: "1.2em", fontWeight: 600, color: "rgb(53, 97, 85)" }}>
                            Total: ${getTotal()}
                        </Typography>
